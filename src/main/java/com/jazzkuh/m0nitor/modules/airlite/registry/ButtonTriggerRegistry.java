...
public class ButtonTriggerRegistry {
	...
	static {
		...
		registerAction(new ButtonTrigger(ControlButton.LED_6A, TriggerType.BUTTON_PRESSED), HueSceneTrigger.class);

		registerAction(new ButtonTrigger(ControlButton.LED_7A, TriggerType.BUTTON_PRESSED), SceneTrigger.class);
		registerAction(new ButtonTrigger(ControlButton.LED_7B, TriggerType.BUTTON_PRESSED), MusicAmbianceTrigger.class);
